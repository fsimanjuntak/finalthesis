...
include = ' -I../build/ -I../libclandmark/ -I../3rd_party/rapidxml-1.13/ -I../3rd_party/CImg-1.5.6/ -I../3rd_party/CImg-1.5.6/plugins';
...
if (ispc)
    ...
    libclandmark = ' -L../build_new/Release -lclandmark -lflandmark -DDOUBLE_PRECISION=1 ';
